...
from models import Classifier_MLP, Classifier_MLPDropout
...
model = Classifier_MLPDropout(in_dim=input_size, hidden_dim=hidden_size, out_dim=num_classes)
...
for epoch in range(epochs):  # loop over the dataset multiple times
    ...
    #learning_rate *= 0.998
    #momentum *= 1.001
    #if momentum>=0.99: momentum = torch.tensor(0.99)
